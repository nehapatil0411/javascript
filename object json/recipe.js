let recipesData = {
  ...
  recipes.forEach((e)=>{
    document.write("ID - " +e .id + "<br>");
    document.write("Name - "+e .name + "<br>");
    document.write("Ingredients - " +e .ingredients[0]+"<br>");
    document.write("Instructions - "+e .instructions[3] + "<br>");
    document.write("Cook Time Minutes - "+e .cookTimeMinutes+ "<br>");
    document.write(" Servings - "+e .servings+ "<br>");
    document.write(" UserId - "+e .userId+ "<br>");
    document.write(" Ratings - "+ e .rating+ "<br>");
  });
